...
<h1 align="center">Carpentry Complaints</h1>
<table width="95%" align="center" border="0" cellpadding="5" cellspacing="5">
<tr align="center">
<td width="39%" align="right">Enter your name : </td>
<td id="userTbox" width="25%" align="left"><input type="text" name="username" size="12" /></td>
<td id="problemHead" align="right" valign="top">Problem : </td>
<td align="left">
<input type="checkbox" name="p1" value="1" /> Door latch repair.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Cupboard latch repair.
</tr>
<tr id="otherdesig"  style="display:none">
<td>&nbsp;</td>
<td align="left" ><input type="text" name="otherdesignation" size="26" /></td>
</tr>
<tr align="center"><td align="right">Problem Location : </td>
...
<input type="checkbox" name="p3" value="4" />Window glass repair.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
&nbsp;&nbsp;<br>&nbsp;<br>Room No. : <input type="text" name="roomno" value=""size="2" /><br />
...
&nbsp;&nbsp;<br>&nbsp;<br>Quarter No. :<input type="text" name="quarterno" value=""size="3" /></div>
...
<input type="checkbox" name="p4" value="8" />Window handles,hooks repair.<br><br><input type="checkbox" name="p5" value="16" />Door stopage problem.</td>
</tr>
...
</td><td align="right">Problem Description :</td>
<td align="left">
<input type="hidden" name="p6" value="32" />
<input type="checkbox" id = "descCheck" name="p7" value="64" />Others<br>
<textarea id = "descBox" name = "descBox" rows = "3" cols = "25" PLACEHOLDER="Please describe your problem here..." ></textarea>
</td>
</tr>
<tr align="center">
...
<div id="left">
	<div class="box">
			<marquee>Save Forests Save Nation</marquee><br><br><br><br><br>
              
	</div>
		
	   
</div>
<img src="images/car.jpg"width="250"height="250"align="left">	
</div>
